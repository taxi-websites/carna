...
import DownloadRedirect from "@/components/download-redirect-driver"
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://carnaapp.com/${lang}/driver`,
      languages: {
        en: "https://carnaapp.com/en/driver",
        ar: "https://carnaapp.com/ar/driver",
      },
    },
    openGraph: {
      type: "website",
      ...
      description: isArabic
        ? "حمّل تطبيق كارنا على جهازك وابدأ رحلتك معنا"
        : "Download Carna app on your device and start your journey with us",
      url: `https://carnaapp.com/${lang}/driver`,
    },
  }
}
